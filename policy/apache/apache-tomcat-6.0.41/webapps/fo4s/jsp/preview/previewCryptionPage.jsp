...
function dataEncrypt() {
    ...
    $.ajax({
        type : "post",
        url : "<c:url value='/dataEncryptTest.aj'/>",
        dataType : "html",
        ...
        success : function(response) {
        	...
        	content  += "<tr>";
        	content  += "<td>" + "encryptionData" +"<td>";
			content  += "<td>" + "decryptionData" +"<td>";
			content  += "<tr>";
			for (var i = 0; i < data.result.length; i++) {
				content  += "<tr>";
				content  += "<td>" + data.result[i].encryptionData +"<td>";
				content  += "<td>" + data.result[i].decryptionData +"<td>";
				content  += "<tr>";
			}
			content += "<table>";
...
<!-- 									<input type="text"  readonly="readonly"/> -->
						...
						<input type="button" class="btn" id="dataEncrypt" value="암복호화" />
