    ...
    $.ajax({
        ...
        success : function(data) {
        	if (data == "fail") {
            	...
            	alert("키 암호키가 이미 존재합니다");
            } else if (data == "success") {
            	alert("키 암호키가 생성 되었습니다.");
            } 
        },
    ...
    $.ajax({
        ...
        success : function(data) {
        	if (data == "fail") {
        		...
        		alert("키 암호키가 없습니다. 먼저 생성해야 합니다.");
        	}else if (data == "success") {
            	alert("키암호 키가 재생성 되었습니다. 반드시 암호키를 재생성 하여야 정상적으로 암복호화가 가능합니다.");
            } else if (data == "disabled") {
            	alert("재생성한 키암호키가 이미 존재합니다.");
            } 
        },
        error : function(xhr, textStatus) {
//         	alert("error");
					...
					<table class="table table-condensed">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="password"  id="passwordInput" name="encrypt_key" maxlength="16"/>&nbsp;1개이상의 대문자,숫자,특수문자포함 8자이상<div class="" id="passwordStrength"></div></td>
							</tr>
							<tr>
							...
							<tr>
								<th class="al"> </th>
								<td><input type="button" class="btn" id="register" value="생성" />&nbsp;&nbsp;<input type="button" class="btn" id="remake" value="재생성" /></td>
							</tr>
						</tbody>
					</table>
				</form>	
