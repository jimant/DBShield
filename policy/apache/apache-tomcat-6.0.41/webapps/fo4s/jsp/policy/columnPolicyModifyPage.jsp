...
function modify() {
    ...
    $.ajax({
        ...
        success : function(data) {
            if (data == "success") {
            	alert("수정완료");
            	location.href = "./columnPolicyView.do";
            } 
        },
...
<!-- 									<input type="text"  readonly="readonly"/> -->
								...
								<tr>
									...
									<td><input type="password"  id="hash_salt" name="hash_salt" readonly="readonly" value="" maxlength="16"/>&nbsp;1개이상의 대문자,숫자,특수문자포함 8자이상<div class="" id="saltStrength"></div></td>
								</tr>
								<tr>
...
<!-- 									<input type="text"  readonly="readonly"/> -->
								...
								<tr>
									<th class="al"> Iv</th>
									<td><input type="password"  id="iv_value" name="iv_value" readonly="readonly" value="" maxlength="16"/>&nbsp;1개이상의 대문자,숫자,특수문자포함 8자이상<div class="" id="ivStrength"></div></td>
								</tr>
								<tr>
...
<!-- 									<input type="text" readonly="readonly"/> -->
								...
								<tr>
									...
									<td><input type="text"  id="mask_digit" name="mask_digit" readonly="readonly" value="" maxlength="16"/>&nbsp;ex) 1,5.8,12</td>
								</tr>
								<tr>
									<th class="al"> Mask</th>
									<td><input type="text"  id="mask_value" name="mask_value" readonly="readonly" value="" maxlength="1"/>&nbsp;ex) # 또는 * 입력</td>
								</tr>
								<tr>
									<th class="al"> </th>
