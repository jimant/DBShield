					...
					<table class="table table-striped table-bordered table-hover table-condensed">
						...
						<%for (int i = 0; i < list.size(); i++) {PolicyVO policyVO = (PolicyVO) list.get(i);%>
							...
							<tr class="ac">
								...
								<td><%=policyVO.getHash_salt() %></td>
								<td><%=policyVO.getIv_value() %></td>
								<td><%=policyVO.getPartial_encrypt_length() %></td>
								<td><%=policyVO.getMask_digit() %></td>
								<td><%=policyVO.getMask_value() %></td>
								<td><%=policyVO.getSystem_apply_date() %></td>
