...
<%@ page import="kr.co.jimant.home.encryption.ConnectionVO"%>
<%
...
<!-- 									<input type="text"  readonly="readonly"/> -->
								...
								<tr>
									...
									<td><input type="password"  id="hash_salt" name="hash_salt" readonly="readonly"/>&nbsp;1개이상의 대문자,숫자,특수문자포함 8자이상<div class="" id="saltStrength"></div></td>
								</tr>
								<tr>
...
<!-- 									<input type="text"  readonly="readonly"/> -->
								...
								<tr>
									<th class="al"> Iv</th>
									<td><input type="password"  id="iv_value" name="iv_value" readonly="readonly" />&nbsp;1개이상의 대문자,숫자,특수문자포함 8자이상<div class="" id="ivStrength"></div></td>
								</tr>
								<tr>
...
<!-- 									<input type="text"  readonly="readonly"/> -->
								...
								<tr>
									...
									<td><input type="text"  id="partial_encrypt_length" name="partial_encrypt_length" value="0" onkeydown="onlyNumber();" readonly="readonly" /> &nbsp;숫자만 입력가능</td>
								</tr>
								<tr>
...
<!-- 									<input type="text" readonly="readonly"/> -->
								...
								<tr>
									...
									<td><input type="text"  id="mask_digit" name="mask_digit" readonly="readonly" /> &nbsp;ex) 1,5.8,12</td>
								</tr>
								<tr>
									<th class="al"> Mask</th>
									<td><input type="text"  id="mask_value" name="mask_value" readonly="readonly" maxlength="1"/> &nbsp;# or *</td>
								</tr>
								<tr>
									<th class="al"> </th>
