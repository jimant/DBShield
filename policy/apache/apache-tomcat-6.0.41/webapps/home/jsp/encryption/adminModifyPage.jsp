...
<%@ page import="kr.co.jimant.home.encryption.AdminVO"%>
<%
					...
					<table class="table table-condensed">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="med gray" name="password" value="<%=adminVO.getPassword() %>"  /></td>
							</tr>
							<tr>
								<th class="al"> 관리자 이름</th>
								<td><input type="text" class="med gray" name="name" value="<%=adminVO.getName() %>"  /></td>
							</tr>
							<tr>
