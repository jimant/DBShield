...
import java.util.*;
import kr.co.hitcom.rent.encryption.AdminVO;
...
public final class adminViewPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	ArrayList<AdminVO> list = (ArrayList) request.getAttribute("list");
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("function adminDelete(admin_id){\r\n");
      out.write("\tif (confirm(\"삭제 하시겠습니까?\")) {\r\n");
      out.write("\t\t$(\"#deleteID\").val(admin_id);\r\n");
      out.write("\t\tdeleteform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("function adminModify(admin_id){\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#modifyID\").val(admin_id);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<th>관리자 이름</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>관리자 권한</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</thead>\r\n");
...
for (int i = 0; i < list.size(); i++) {AdminVO adminVO = (AdminVO) list.get(i);
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(adminVO.getPassword() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(adminVO.getName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(adminVO.getPermission() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"button\" value=\"수정\" id=\"modify\" onclick=\"javascript:adminModify('");
      out.print(adminVO.getAdmin_id());
      out.write("')\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"button\" value=\"삭제\" id=\"delete\" onclick=\"javascript:adminDelete('");
      out.print(adminVO.getAdmin_id());
      out.write("')\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t<form action=\"./adminModifyPage.do\" method=\"post\" name=\"modifyform\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"modifyID\" name=\"admin_id\">\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<form  action=\"./adminDelete.do\" method=\"post\" name=\"deleteform\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"deleteID\" name=\"admin_id\">\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
