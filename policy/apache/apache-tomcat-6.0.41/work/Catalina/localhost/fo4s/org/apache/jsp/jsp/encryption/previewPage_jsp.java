...
public final class previewPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<form action=\"./previewEncryptPage.do\" method=\"post\" id=\"dbConnectionform\" name=\"dbConnectionform\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> Select DB</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"med gray\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"ml10\" name=\"selectDB\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> Host</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"med gray\" name=\"host\" value=\"localhost\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> User</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"med gray\" name=\"user\" value=\"root\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> Password</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"password\" class=\"med gray\" name=\"password\" value=\"hitcom123\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> DB Name</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"med gray\" name=\"database\" value=\"CUSTOM_DB\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> Port</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"med gray\" name=\"port\" value=\"3306\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td> <input type=\"submit\" value=\"연결\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
