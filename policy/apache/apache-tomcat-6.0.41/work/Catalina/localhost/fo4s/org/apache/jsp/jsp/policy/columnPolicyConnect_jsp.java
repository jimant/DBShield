...
public final class columnPolicyConnect_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(\"#db_type\").click(function(event) {\r\n");
      out.write("\t\tif ($(\"#db_type\").val() == \"O\") {\r\n");
      out.write("\t\t\t$(\"#db_name\").show();\r\n");
      out.write("\t\t} else if($(\"#db_type\").val() == \"M\"){\r\n");
      out.write("\t\t\t$(\"#db_name\").hide();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t<H3>DB 연결</H3>\r\n");
      out.write("\t\t\t\t<form action=\"./columnPolicyPage.do\" method=\"post\" id=\"dbConnectionform\" name=\"dbConnectionform\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"ml10\" id=\"db_type\" name=\"db_type\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"M\">MySQL</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"O\">Oracle</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr id=\"db_name\" style=\"display:none\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class=\"al\"> DB 이름</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"db_name\" value=\"orcl\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"user\" value=\"root\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td> <input type=\"submit\" class=\"btn\" value=\"연결\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
