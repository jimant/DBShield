package org.apache.jsp.jsp.key;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class eckBackupPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        data : $(\"#informationform\").serialize(),\r\n");
      out.write("        success : function(response) {\r\n");
      out.write("        \tif (response == \"fail\") {\r\n");
      out.write("        \t\talert(\"아이디 또는 비밀번호를 잘못 입력하셨습니다.\");\r\n");
      out.write("            } else if (response == \"permission\") {\r\n");
      out.write("            \talert(\"권한이 업습니다.\");\r\n");
      out.write("            } else if (response == \"nothing\") {\r\n");
      out.write("            \talert(\"암호키가 존재하지 않습니다.\");\r\n");
      out.write("            } else {\r\n");
      out.write("            \tvar data = jQuery.parseJSON(response);\r\n");
      out.write("            \talert(\"암호키 백업완료!\\n\"+\"파일경로: \"+data.result[0].KEY_PATH+\"\\n파일명: \"+data.result[1].ECK_FILE_NAME);\r\n");
      out.write("            }\r\n");
      out.write("        },\r\n");
      ...
      out.write("            } else if (response == \"nothing\") {\r\n");
      out.write("            \talert(\"암호키가 존재하지 않습니다.\");\r\n");
      out.write("            } else if (response == \"nofile\") {\r\n");
      out.write("            \talert(\"백업파일이 존재하지 않습니다.\");\r\n");
      out.write("            } else {\r\n");
      out.write("            \tvar data = jQuery.parseJSON(response);\r\n");
      out.write("            \talert(\"암호키 복구완료!\\n\"+\"파일경로: \"+data.result[0].KEY_PATH+\"\\n파일명: \"+data.result[1].ECK_FILE_NAME);\r\n");
      out.write("            }\r\n");
      out.write("        },\r\n");
      out.write("        error : function(xhr, textStatus) {\r\n");
      out.write("//         \talert(\"error\");\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t$(\"#backup\").click(function(event) {\r\n");
      out.write("\t\tbackup();\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#restore\").click(function(event) {\r\n");
      out.write("\t\trestore();\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      ...
      out.write("\t\t<H3>암호키 백업복구</H3>\r\n");
      out.write("\t\t\t\t<form  method=\"post\" id=\"informationform\" name=\"informationform\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"button\" class =\"btn\" id=\"backup\" value=\"백업\" />&nbsp;&nbsp;<input type=\"button\" class =\"btn\" id=\"restore\" value=\"복구\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\t\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(PageContext _jspx_page_context)
    ...
    // /jsp/key/eckBackupPage.jsp(15,15) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f0.setValue("/eckBackup.aj");
  ...
  private boolean _jspx_meth_c_005furl_005f1(PageContext _jspx_page_context)
    ...
    // /jsp/key/eckBackupPage.jsp(41,15) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f1.setValue("/eckRestore.aj");
